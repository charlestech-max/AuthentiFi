...
Cloning the repo
```
$ git clone https://github.com/charles-alchemcy/AuthentiFi.git
```
...
1. Fork it (<https://github.com/charles-alchemcy/AuthentiFi/fork>)
...
+ [Charles Alchemcy](https://github.com/charles-alchemcy) <br>
+ [Pratik Nerurkar](https://github.com/PlayPratz) <br>

See also the list of [contributors](https://github.com/charles-alchemcy/AuthentiFi/contributors) who participated in this project.
